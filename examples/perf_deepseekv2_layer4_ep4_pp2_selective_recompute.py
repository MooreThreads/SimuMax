...
def set_megatron_config(perf_model:PerfLLM):
    perf_model.model_config.layer_num = 4 # Cut the layer to 4 to align the configuration of the benchmark in Megatron
...
def main():
    ...
    strategy_config_file = get_simu_strategy_config('ep4_pp2_dp4_mbs1_selective_recompute')
    model_config_file = get_simu_model_config('deepseekv2')
