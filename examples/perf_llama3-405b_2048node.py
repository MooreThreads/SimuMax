...
def main():
    ...
    strategy_config_file = "../configs/strategy/tp8_pp16_dp128_mbs1_no_ckpt.json"
    model_config_file = "../configs/models/llama3-405b_padding_128.json"  # we haven't supported uneven split yet
