...
def set_megatron_config(perf_model:PerfLLM):
    perf_model.model_config.layer_num = 12  # Cut the layer to 12 to align the configuration of the benchmark in Megatron
...
def main():
    ...
    strategy_config_file = get_simu_strategy_config('tp2_pp1_dp4_mbs1_selective_recompute')
    model_config_file = get_simu_model_config('llama3-70b')
